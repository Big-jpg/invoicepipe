#==============================================================================
# test_live.ps1 - Test live Container App endpoints
#==============================================================================
...
if (-not $FilePath) {
    $FilePath = "LOCAL_URL_TO_PDF_WITH_EXTENSION.PDF"
}
...
Write-Host "================================================================================"
Write-Host "🧪 Live Container App Tests"
Write-Host "================================================================================"
...
if ($Environment -eq "DEV") {
    $BaseUrl = if ($env:OCR_DEV_CONTAINER_URL) { $env:OCR_DEV_CONTAINER_URL } else { "https://contoso-invoice-cu-api-dev.australiaeast.azurecontainerapps.io" }
} else {
    $BaseUrl = if ($env:OCR_PRD_CONTAINER_URL) { $env:OCR_PRD_CONTAINER_URL } else { "https://contoso-invoice-cu-api.australiaeast.azurecontainerapps.io" }
}
